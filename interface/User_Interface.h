...
#define Auto_ClipObj			12

#define MenuMax					7

/* Exported variables --------------------------------------------------------*/
extern Menu_Struct_TypeDef gInterfaceMenu, QuickMenu, ChannelA_Menu;
extern Menu_Struct_TypeDef ChannelB_Menu, DigitTrigMenu, TrigMenu, MeasMenu;
extern Menu_Struct_TypeDef AdvancedMenu;
